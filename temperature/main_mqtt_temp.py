...
def connect_and_subscribe():
    ...
    global client_id, MQTT_BROKER, topic_sub
    ...
    client = MQTTClient(client_id, MQTT_BROKER, user=MQTT_USER, password=MQTT_PSW)
...
def restart_and_reconnect():
    ...
    # the reset() method.
    print('Failed to connect to MQTT broker try reconnecting...')
    sleep(10)
    machine.reset()
